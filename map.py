...
for i in range(2,49):
    vetIcon = folium.features.CustomIcon(vet, icon_size=(22, 22))
...
sheet_one = wb.active
for i in range(2,8):
    zooIcon = folium.features.CustomIcon(zoo, icon_size=(24, 24))
...
sheet_two = wb.active   
for i in range(2,8):
    priutIcon = folium.features.CustomIcon(priut, icon_size=(26, 26))
...
for i in range(2,26):
    cafeIcon = folium.features.CustomIcon(cafe, icon_size=(24, 24))
...
for i in range(2,6):
    parkIcon = folium.features.CustomIcon(park, icon_size=(26, 26))
